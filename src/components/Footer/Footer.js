...
export default function Footer() {
  return (
    <footer className='bg-black w-full mt-40'>
      <div className='container'>
        <div className='flex items-center flex-wrap py-16 gap-5 sm:gap-10 justify-between'>
          <div>
            ...
            <p className='text-secondery-color font-TestSohneMono'>get it on system</p>
          </div>
          <div>
        ...
        <hr className='w-full text-primary-color' />
        <div className='flex items-center flex-wrap gap-3 justify-between px-5 py-5'>
          <p className='text-white text-xs sm:text-sm lg:text-base'>©2024 Pixee Game</p>
