    ...
    <>
      <div className='container flex flex-col lg:flex-row lg:gap-10 justify-center w-full mx-auto'>
        <div className='flex flex-col'>
          <div>
            <div>
              <p className='font-BebasNeueRegular text-secondery-color text-xs sm:text-xl'>STOTY BOOK</p>
              <h2 className='font-BebasNeueRegular text-white text-xl sm:text-4xl'>THE PIXEE STORY</h2>
            </div>
            <p className='text-white text-xs sm:text-lg lg:text-xl leading-relaxed mt-4 mb-5 font-TestSohneMono'>Behind every game, there’s a team of creative, skilled, and passionate individuals. Our studio members bring together diverse talents in design, programming, art, audio, and production to build unforgettable worlds. We believe that every project is the result of close collaboration, shared passion, and collective experience. Get to know the people who bring our games to life.</p>
          </div>
          <Swiper
