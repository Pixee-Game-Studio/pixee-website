...
export default function Studio() {
  ...
  return (
    <div
      id="studio"
      className="container mx-auto flex w-full flex-col justify-center gap-10 xl:px-[50px]"
    >
      ...
      <div className="sm:px[30px] mx-auto flex w-full flex-wrap justify-between gap-10 px-0 lg:px-[80px]">
        ...
        <div>
          <p id="scramble-text-6" className="font-IMBPlex text-sm text-text-color lg:text-xl">
            RELEASE DATE
          </p>
        ...
        <div>
          ...
          <h1 id="scramble-text-7" className="font-IMBPlex text-sm text-white lg:text-xl">
            Survival-Horror
          </h1>
        </div>
